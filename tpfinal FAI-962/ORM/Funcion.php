...
class Funcion
{
    ...
    public function insertar()
    {
        ...
        if ($base->Iniciar()) {
            if ($id = $base->devuelveIDInsercion($consultaInsertar)) {     //se usa cuando se trabaja con id autoincrementables, me devuelve la id si la consulta pudo ser realizada
