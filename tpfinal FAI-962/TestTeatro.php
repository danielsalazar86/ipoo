...
include_once "transiciones/abmFuncion.php";
include_once "transiciones/abmTeatro.php";
include_once "transiciones/abmCine.php";
include_once "transiciones/abmMusical.php";
include_once "transiciones/abmObra.php";
...
function menu()
{
    ...
    echo " 1) Cargar Teatro" . "\n" .
        ...
        " 9) Dar costo del uso de un teatro" . "\n" .
        " 10) Eliminar Teatro" . "\n" .
        " 11) Salir" . "\n";
    echo "-----------------------------------" . "\n";
